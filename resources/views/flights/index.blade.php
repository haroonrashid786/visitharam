@extends('layouts.app')
@section('title', 'Flights Data')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Flights</h4>
                {{--                {{ $errors }}--}}
    ...
    <div class="w-100">
        <a href="{{ route('add.flight') }}" class="btn btn-primary">Add Flights</a>
    ...
    <script>
        $('#datatable').DataTable({
            ...
            order: [[3, 'desc']] // Change '0' to the index of the column you want to order by
        });


        $('#datatable').on('click', '.delete-flight', function () {
            ...
            if (confirm('Are you sure you want to delete this flight?')) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        showSnackbar('Flight deleted successfully.');
                        setTimeout(function () {
